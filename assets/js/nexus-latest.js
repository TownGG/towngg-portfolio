(() => {
  ...
  const translations = {
    en: { Updated: "Updated {time}", "Nexus latest snapshot is older than the expected hourly sync window.": "Nexus latest snapshot is older than the expected hourly sync window.", "Nexus latest snapshot loaded independently from the trend chart.": "Nexus latest snapshot loaded independently from the trend chart." },
    "zh-CN": { "Unique Downloads": "唯一下载", "Daily Downloads": "每日下载", "Yesterday Downloads": "昨日下载", "Total Downloads": "总下载", Endorsements: "点赞", Updated: "更新于 {time}", "Nexus latest snapshot is older than the expected hourly sync window.": "Nexus 最新快照已超过预期的每小时同步窗口。", "Nexus latest snapshot loaded independently from the trend chart.": "Nexus 最新快照已独立于趋势图加载。" },
    "zh-TW": { "Unique Downloads": "唯一下載", "Daily Downloads": "每日下載", "Yesterday Downloads": "昨日下載", "Total Downloads": "總下載", Endorsements: "按讚", Updated: "更新於 {time}", "Nexus latest snapshot is older than the expected hourly sync window.": "Nexus 最新快照已超過預期的每小時同步視窗。", "Nexus latest snapshot loaded independently from the trend chart.": "Nexus 最新快照已獨立於趨勢圖載入。" },
    ja: { "Unique Downloads": "ユニークダウンロード", "Daily Downloads": "日別ダウンロード", "Yesterday Downloads": "昨日のダウンロード", "Total Downloads": "総ダウンロード", Endorsements: "支持数", Updated: "更新 {time}", "Nexus latest snapshot is older than the expected hourly sync window.": "Nexus最新スナップショットは想定される毎時同期ウィンドウより古くなっています。", "Nexus latest snapshot loaded independently from the trend chart.": "Nexus最新スナップショットはトレンドチャートとは独立して読み込まれました。" },
    ko: { "Unique Downloads": "고유 다운로드", "Daily Downloads": "일일 다운로드", "Yesterday Downloads": "어제 다운로드", "Total Downloads": "총 다운로드", Endorsements: "추천", Updated: "업데이트 {time}", "Nexus latest snapshot is older than the expected hourly sync window.": "Nexus 최신 스냅샷이 예상된 시간별 동기화 범위보다 오래되었습니다.", "Nexus latest snapshot loaded independently from the trend chart.": "Nexus 최신 스냅샷이 추세 차트와 별도로 로드되었습니다." },
    ru: { "Unique Downloads": "Уникальные загрузки", "Daily Downloads": "Ежедневные загрузки", "Yesterday Downloads": "Загрузки вчера", "Total Downloads": "Всего загрузок", Endorsements: "Лайки", Updated: "Обновлено {time}", "Nexus latest snapshot is older than the expected hourly sync window.": "Последний снимок Nexus старше ожидаемого часового окна синхронизации.", "Nexus latest snapshot loaded independently from the trend chart.": "Последний снимок Nexus загружен отдельно от графика тренда." }
  };
