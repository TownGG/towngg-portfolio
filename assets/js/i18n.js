(() => {
  ...
  function injectStyle() {
    ...
    style.textContent = `
      ...
      @media(max-width:980px){.nav{display:flex}.language-switcher{margin-left:auto}.nav-toggle{order:4}.nav-links{right:0}}@media(max-width:520px){.language-button-label{display:none}.language-button{width:42px;justify-content:center;padding:0}}
    `;
